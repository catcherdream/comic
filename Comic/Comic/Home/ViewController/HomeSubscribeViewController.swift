//
//  HomeSubscribeViewController.swift
//  Comic
//
...
class HomeSubscribeViewController: BaseViewController {
    ...
    override func viewDidLoad() {
        ...
        ApiLoadingProvider.request(ComicApi.subscribeList, model: SubscribeListModel.self) { (returnData) in
...
extension HomeSubscribeViewController: UCollectionViewSectionBackgroundLayoutDelegateLayout, UICollectionViewDataSource,HomeComicHeadViewDelegate{
    ...
    func collectionView(_ collectionView: UICollectionView, viewForSupplementaryElementOfKind kind: String, at indexPath: IndexPath) -> UICollectionReusableView {
        if kind == UICollectionElementKindSectionHeader {
            ...
            head.delegate = self
            head.model = subscribeList[indexPath.section]
            return head
        } else {
